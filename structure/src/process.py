...
for sentence in tqdm.tqdm(sentence_list):
    ...
    for i in range(len(sentence)):
        ...
        if word not in word2count: # 1-gram
            word2count[word] = 1
        else:
            word2count[word] += 1
...
if args.three == 'yes': # remove 3-gram below count
